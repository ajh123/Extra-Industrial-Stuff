...
@Mod("extra_industrial_stuff")
public class ExtraIndustrialStuffMod {
	public static final Logger LOGGER = LogManager.getLogger(ExtraIndustrialStuffMod.class);
	public static final String MODID = "extra_industrial_stuff";
